            ...
            <div class="span8">
                ...
                <form method="POST">
                  <div class="row-fluid">
                        ...
                        <input type="text" name="fname" class="input-block-level" required="required" placeholder="Your First Name" pattern="[a-zA-Z0-9]+[a-zA-Z0-9 ]+" >
                        <label>Last Name</label>
                        <input type="text" name="lname" class="input-block-level" required="required" placeholder="Your Last Name" pattern="[a-zA-Z0-9]+[a-zA-Z0-9 ]+" >
        ...
        if(isset($_POST['subs'])){
            ...
            global $dbh;
                try{
                        ...
                        $passval = array(null,$snd,$snd,$msg,$stat,$link);
