                ...
                <section class="content">
                    ...
                    <!-- progressbar -->
                        ...
                        <fieldset style="margin-bottom:50px;">
                            ...
                            <?php
                                ...
                                while($row = $query->fetch()){
                                    ...
                                    echo '<p style="text-align:left;">
                                            <a href="pdf/class_card.php?sid='.$sid.'&eid='.$eid.'" target="_blank">
                            ...
                            <a href="reportsTutor.php?eid=<?php echo $_GET['eid']?>&type=<?php echo $type?>"><input type="button" name="next" class="next action-button" value="Back" required/></a>
                        </fieldset>
