            ...
            <!-- progressbar -->
                ...
                <fieldset style="margin-bottom:50px;">
                    ...
                    <h2 class="fs-title">Project Logs &nbsp;</h2>
                     <a href="pdf/proj_log.php?pid=<?php echo $pid; ?>&eid=<?php echo $eid; ?>&type=<?php echo $type; ?>" target="_blank"><button class="btn btn-success btn-sm" type="button"><i class="fa fa-file-o"></i> View PDF</button></a>
                    <?php
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php if($type=='acc'){     
                                    echo '<a href="accomplishedProject.php?id='.$ayo.'&stat=finished"><button type="button" style="width:25%;" name="previous" class="btn btn-danger"/>BACK</button></a>';
                                }elseif($type == 'ongoing'){
                                   echo' <a href="ongoingProject.php?id='.$ayo.'&stat=ongoing"><button type="button" style="width:25%;" name="previous" class="btn btn-danger"/>BACK</button></a>';
                                }
                                ?>
                </fieldset> 
