                                        ...
                                        if(isset($_GET['s'])){
                                            ...
                                            if($status=='del'){
                                                 echo '<div class="alert alert-success" id="alert" style="visibility: true; display: block; width:90%;">
                                                        ...
                                                        <strong>Success!</strong> A class has been deleted.
                                                        </div>';
                                    ...
                                    <div class="box-body table-responsive">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th colspan="1" rowspan="1"><i class="fa fa-calendar"></i> Schedule</th>
                                                <th colspan="1" rowspan="1"><i class="fa fa-book"></i> Sessions</th>
                                                <th colspan="1" rowspan="1"><i class="fa fa-flag"></i> Status</th>
                                                <th colspan="1" rowspan="1"><i class="fa fa-book"></i> Classcard</th>
                                        </thead>
                                        <tbody>
                                           <?php echo $db -> fetchClassReport() ?>
                                        </tbody>
                                    </table>
