                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <div class="box-header">
                                    <a href="listProjects.php"><br>&nbsp;&nbsp;&nbsp; < < < Back to Added Projects</a><br>
                                ...
                                <div class="box-body table-responsive">
                                     ...
                                     <?php 
                                        ...
                                        echo '<p>Total Number of Hours: <b>&nbsp;'.$hours.' hours and '.$minutes.' minutes</b></p></div><br><br><br><br><br><br><br>';
...
<?php
    if(isset($_GET['eid'])){
        ...
        $query2 = $dbh->query("SELECT projectName as `pn` FROM project WHERE projectID='$pid'");
        ...
        while($row = $query->fetch()){
            while($row2 = $query2->fetch()){
                ...
                echo $db ->subDrafts($pid,$eid,$id,$time,$date,$msg,$icon);
            }
        }
