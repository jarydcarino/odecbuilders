...
<?php 
	...
	$query = $dbh->query("SELECT CONCAT(s.firstName, ' ', s.lastName) as `sname`, studentID as `sid`, skillName as `sn`, t.studID as `sid`
...
<h1><img src="../img/logo1.png" width="187">&nbsp;&nbsp;TUTOR REPORTS - FINISHED CLASSES</h1>
