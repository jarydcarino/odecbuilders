                ...
                <section class="content">
                    ...
                    <!-- progressbar -->
                        ...
                        <fieldset style="margin-bottom:50px;">
                                                ...
                                                try{
                                                    $query = $dbh->query("SELECT c.date as `d`, CONCAT(e.firstName,' ', e.lastName) as `i`, 
                                                        attendance as `a`                   
                                                                        ...
                                                                        WHERE t.empID = '$ayo' AND s.studentID = '$sid'
                                                                        ORDER BY c.date ");
                            ...
                            <a href="accomplishedClasses.php?eid=<?php echo $ayo;?>&type=finished"><input type="button" name="next" class="next action-button" value="Back" required/></a>
                        </fieldset>
