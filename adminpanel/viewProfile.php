                            ...
                            <div id="mainArea" class="quickFade delayFive">
                                ...
                                <section>
                                    ...
                                    <div class="sectionContent">
                                        ...
                                        $query2 = $dbh->query("SELECT se.empID as `empid`, se.skillID as `skillid`, GROUP_CONCAT(s.skillName, ' ') as `sn` FROM skillemp se JOIN skills s ON se.skillID=s.skillID WHERE empID= '$tid';
                                                            ");
