                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class ="box-title"><i class="fa fa-user"></i> List of Draftsman</h3>
                                </div>                                
                                    <div class="box-body">
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th colspan="1" rowspan="1"><i class="fa fa-legal"></i> Skills</th>
                                                <th colspan="1" rowspan="1"><i class="fa fa-calendar"></i> Options</th>

                                        </thead>
                                    <tbody>
                                            <?php echo $db -> fetchDraftsman() ?>
