                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <div style="margin-left:10px;">
                                    <a href="assignStudents.php"><button class="btn btn-default"><span class="glyphicon glyphicon-plus"></span> Assign Student</button></a>
                                </div>
                                <div class="box-body table-responsive">
                                    ...
                                    if(isset($_GET['s'])){
                                        ...
                                        if($s == 'd'){
                                            ...
                                            <strong>Success!</strong> You have dropped a class.
                                        </div>';
                                            ...
                                            echo '<div class="alert alert-success" id="alert" style="visibility: true; display: block; width:90%;">
                                            <a href="#" class="close" data-dismiss="alert">&times;</a>
                                            <strong>Success!</strong> You have deleted a class. All records related to the class are also deleted.
                                        </div>';
                                        }else if($s == 'sub'){
                                            echo '<div class="alert alert-success" id="alert" style="visibility: true; display: block; width:90%;">
                                                <a href="#" class="close" data-dismiss="alert">&times;</a>
                                            ...
                                            echo '<div class="alert alert-success" id="alert" style="visibility: true; display: block; width:90%;">
                                                <a href="#" class="close" data-dismiss="alert">&times;</a>
                                                <strong>Success!</strong> A new student has been added.
                                            </div>';
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th colspan="1" rowspan="1" style="width:150px;"><i class="fa fa-clock-o"></i> Remaining Session</th>
