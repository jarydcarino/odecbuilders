                ...
                <div class="nav-collapse collapse pull-right">
                    <ul class="nav">
                       <!--  <li class="active"><a href="index.html">Home</a></li> -->
                        ...
                        <li><a href="about-us.html"><i class="icon-info-sign"></i>&nbsp;About</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-briefcase"></i>&nbsp;Services<i class="icon-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="drafting.html">Drafting Services</a></li>
                                <li><a href="tutorial.html">School/Tutorial</a></li>
                                <li><a href="buildHouse.html">Build your own House</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-road"></i>&nbsp;Design Build<i class="icon-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="design.html">Design</a></li>
                                <li><a href="on-going.html">On-going Projects</a></li>
                                <li><a href="prevProj.html">Previous Projects</a></li>
                                <li><a href="testimonials.html">Testimonials</a></li>
                            </ul>
                        </li>
                        <li><a href="portfolio.html"><i class="icon-picture"></i>&nbsp;Gallery</a></li>
<!--                         <li class="dropdown">
                        ...
                        <li><a href="contact-us.html"><i class="icon-phone-sign"></i>&nbsp;Contact</a></li>
                        <li class="login">
