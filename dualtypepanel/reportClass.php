                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class ="box-title"><i class="fa fa-clipboard"></i> Class Report <a href="pdf/class_reports_all.php" target="_blank"><button class="btn btn-success btn-sm"><i class="fa fa-file-o"></i> View PDF</button></a></h3>
                                           ...
                                           <?php 
                                                try{
                                                    $query = $dbh -> query("SELECT
                                                        ...
                                                        WHERE instID='$id' AND ss.classsched=1
                                                        GROUP BY ss.studID");
                                                    while($row = $query->fetch()){
                                                        ...
                                                        echo '<td style="text-align:center;"><a href="classcard.php?tid='.$row['tid'].'&name='.$row['name'].'&class='.$row['sn'].'&sid='.$row['sid'].'&type=all"><button class="btn btn-info btn-sm"><i class="fa fa-fw fa-book"></i>&nbsp;View Classcard</button></a></td>';
