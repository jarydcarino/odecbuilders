                ...
                <section class="content">
                    <div class="row">
                                                ...
                                                <?php 
                                                    ...
                                                    if($row["count"] > 0){
                                                      echo  "<input class='btn btn-danger btn-lg' type='submit' value='TIME IN' name='punchin'/>
                                                        ...
                                                        <input class='btn btn-default btn-lg' type='submit' value='Request for Extension' name='request' disabled/>";
                                                    }elseif($row["count"] == 0){
                        ...
                        <div class="col-xs-6">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title"><i class="fa fa-tasks"></i> List of Accomplished Projects</h3>
                                </div><!-- /.box-header -->
